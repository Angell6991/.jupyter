...
c.ConsoleWidget.include_scrollbar = False
...
#  Default: ''
c.JupyterWidget.editor = 'tilix -- nvim {filename}'
...
## The font family to use for the console.
#  See also: ConsoleWidget.font_family
c.JupyterWidget.font_family = "RobotoMono Nerd Font"

## The font size. If unconfigured, Qt will be entrusted
#  See also: ConsoleWidget.font_size
c.JupyterWidget.font_size = 15
